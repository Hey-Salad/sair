...
// Sally Air is dark-mode only for v1.
  ...
  useEffect(() => {
    if (Platform.OS === 'web') {
      ...
      const existingLink = document.querySelector(
        'link[href*="fonts.googleapis.com/css2?family=Figtree"]',
      );
  ...
  return (
    <Stack
      screenOptions={{
        ...
        headerTitleStyle: { color: foreground, fontFamily: 'Figtree_600SemiBold' },
    ...
    >
      ...
      <Stack.Screen name="device/[id]/settings" options={{ title: 'Device Settings' }} />
      <Stack.Screen name="add-device" options={{ title: 'Add Device', presentation: 'modal' }} />
    </Stack>
  );
}
